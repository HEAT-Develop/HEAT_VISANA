...
from PyQt6.QtWidgets import QLabel, QFormLayout, QWidget,QHBoxLayout, QFileDialog, QDialog
...
from src.pages.analysis_folder.add_crater_info import AddInfoCraterDialog
...
class Regions(QWidget):
    def __init__(self, parent=None):
        ...
        self.add_all_info_db = QtWidgets.QPushButton("Add All the Crater info in to the db")
        self.add_all_info_db.clicked.connect(self.add_crater_db)

        bottom_layout.addWidget(self.add_db_button)
        bottom_layout.addWidget(self.add_all_info_db)
    ...
    def add_crater_db (self):
        dlg = AddInfoCraterDialog (self, vtk_file_path=self.vtk_file_path, information=self.analysis_results)
