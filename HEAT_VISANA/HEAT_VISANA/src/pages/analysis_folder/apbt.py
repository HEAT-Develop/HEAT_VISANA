...
# def apply_curvature(mesh):

#     mesh_copy = mesh.smooth_taubin(n_iter=3, pass_band=1.07)
#     mesh_copy.compute_normals(cell_normals = True, point_normals = True, inplace = True)

#     return  mesh_copy, mesh_copy["Normals"]
